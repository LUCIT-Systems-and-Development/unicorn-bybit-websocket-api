...
`unicorn-bybit-websocket-api` project.
...
## Reporting a Bug
`LUCIT Systems and Development` takes all security bugs in `unicorn-bybit-websocket-api` seriously.
Thank you for improving the security of `unicorn-bybit-websocket-api`. We appreciate your 
