...
class TestBybitComManager(unittest.TestCase):
    ...
    def test_create_uri_miniticker_regular_com(self):
        ...
        self.assertEqual(self.__class__.ubwa.create_websocket_uri(["!miniTicker"], ["arr"]),
                         'wss://stream.bybit.com:9443/ws/!miniTicker@arr')
    ...
    def test_create_uri_ticker_regular_com(self):
        ...
        self.assertEqual(self.__class__.ubwa.create_websocket_uri(["!ticker"], ["arr"]),
                         'wss://stream.bybit.com:9443/ws/!ticker@arr')
    ...
    def test_create_uri_userdata_regular_com(self):
        ...
        if len(self.bybit_com_api_key) == 0 or len(self.bybit_com_api_secret) == 0:
            ...
            self.assertRegex(self.__class__.ubwa.create_websocket_uri(["!userData"], ["arr"],
                                                                      stream_id,
                                                                      self.bybit_com_api_key,
                                                                      self.bybit_com_api_secret),
                             r'wss://stream.bybit.com:9443/ws/.')
    ...
    def test_get_exchange(self):
        ...
        self.assertEqual(self.__class__.ubwa.get_exchange(), "bybit.com")
    ...
    def test_start_monitoring_api(self):
        ...
        with BybitWebSocketApiManager(exchange="bybit.com-testnet",
                                        debug=True,) as ubwa:
...
class TestBybitComManagerTest(unittest.TestCase):
    ...
    def test_create_uri_miniticker_regular_com(self):
        self.assertEqual(self.__class__.ubwa.create_websocket_uri(["!miniTicker"], ["arr"]),
                         'wss://testnet.bybit.vision/ws/!miniTicker@arr')
    ...
    def test_create_uri_ticker_regular_com(self):
        self.assertEqual(self.__class__.ubwa.create_websocket_uri(["!ticker"], ["arr"]),
                         'wss://testnet.bybit.vision/ws/!ticker@arr')
    ...
    def test_create_uri_userdata_regular_com(self):
        if BYBIT_COM_TESTNET_API_KEY is not None and BYBIT_COM_TESTNET_API_SECRET is not None:
            print("\r\nempty API key and/or secret: can not successfully test test_create_uri_userdata_regular_com() "
                  "for bybit.com-testnet")
        else:
            stream_id = self.__class__.ubwa.get_new_uuid_id()
            self.__class__.ubwa._add_stream_to_stream_list(stream_id, ["!userData"], ["arr"])
            self.assertRegex(self.__class__.ubwa.create_websocket_uri(["!userData"], ["arr"],
                                                                      stream_id,
                                                                      self.__class__.bybit_com_testnet_api_key,
                                                                      self.__class__.bybit_com_testnet_api_secret),
                             r'wss://testnet.bybit.vision/ws-api/v3')
    ...
    def test_create_uri_userdata_reverse_com(self):
        if BYBIT_COM_TESTNET_API_KEY is not None and BYBIT_COM_TESTNET_API_SECRET is not None:
            ...
            self.assertRegex(self.__class__.ubwa.create_websocket_uri(["arr"], ["!userData"],
                                                                      stream_id,
                                                                      self.bybit_com_testnet_api_key,
                                                                      self.bybit_com_testnet_api_secret),
                             r'wss://testnet.bybit.com/v5')
    ...
    def test_live_api_ws(self):
        ...
        ubwam = BybitWebSocketApiManager(exchange='bybit.com-testnet')
        api_stream = ubwam.create_stream(api=True,
                                         api_key=BYBIT_COM_TESTNET_API_KEY,
                                         api_secret=BYBIT_COM_TESTNET_API_SECRET,
...
class TestApiLive(unittest.TestCase):
    ...
    def test_z_rest_bybit_com_isolated_margin(self):
        ubwa = BybitWebSocketApiManager(exchange="bybit.com-isolated_margin")
        BybitWebSocketApiRestclient(ubwa)
        ubwa.stop_manager()

    def test_z_rest_bybit_com_isolated_margin_testnet(self):
        ubwa = BybitWebSocketApiManager(exchange="bybit.com-isolated_margin-testnet")
        BybitWebSocketApiRestclient(ubwa)
        ubwa.stop_manager()
...
#        self.__class__.ubwa = BybitWebSocketApiManager(exchange="bybit.com-isolated_margin")
...
#        self.__class__.ubwa.stop_manager()
    ...
    def test_exception_maximumsubscriptionsexceeded(self):
        with self.assertRaises(MaximumSubscriptionsExceeded):
            raise MaximumSubscriptionsExceeded(exchange="bybit.com", max_subscriptions_per_stream=1024)
